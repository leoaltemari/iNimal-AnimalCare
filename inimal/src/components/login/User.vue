          ...
          <main id="pet-config">
            ...
            <div class="pet-data save" v-if="addPetDisplay === true">
              ...
              <div class="grid-items">
                ...
                <div class="config-data">
                  <h2>Idade</h2>
                  <input type="text" placeholder="Digite a idade do pet">
                </div>
              </div>
              <!-- Add pet BUTTON - Config BUTTON -->
              <div class="config">
                <a @click.stop.prevent="salvarPet()">Salvar pet</a>
            ...
            <div class="pet-data" v-else>
              ...
              <div class="config-data select-pet">
                  ...
                  <select name="" id="">
                    ...
                    <option v-for="pet in userPets" :key="pet._id">{{pet.name}}</option>
                  </select>
                </div>
              ...
              <div class="config">
                <a @click.stop.prevent="enablePetConfig()" class="rotate">
                <img src="../../assets/img/icons/config_icon.png" alt="">
                  Salvar alterações
                </a>
              </div>
